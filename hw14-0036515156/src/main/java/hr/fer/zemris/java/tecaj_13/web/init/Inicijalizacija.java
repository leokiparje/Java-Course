...
/**
 * Class Inicijalizacija is user to init the application via servlet context listener. It's job is to put entitiy manager factory
 * in servlet's context so it knows how to create an entity manager.
 * @author leokiparje
 *
 */
