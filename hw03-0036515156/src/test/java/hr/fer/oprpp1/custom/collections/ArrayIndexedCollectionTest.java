...
public class ArrayIndexedCollectionTest {
    ...
    public void testElementsGetter() {
        ...
        col2.add("Štefanija");
        col2.add("Karmela");
        ElementsGetter<String> getter1 = (ElementsGetter<String>) col1.createElementsGetter();
        ElementsGetter<String> getter2 = (ElementsGetter<String>) col1.createElementsGetter();
        ElementsGetter<String> getter3 = (ElementsGetter<String>) col2.createElementsGetter();
    ...
    public void testElementsGetterException() {
        assertThrows(NoSuchElementException.class, () -> {
            ...
            col.add("Ana");
            col.add("Jasna");
            ElementsGetter<String> getter1 = (ElementsGetter<String>) col.createElementsGetter();
            String result = "";
            result += getter1.getNextElement() + " ";
            result += getter1.getNextElement() + " ";
            result += getter1.getNextElement() + " ";
    ...
    public void hasNextElementsGetterTest() {
        ...
        col.add("Ana");
        col.add("Jasna");
        ElementsGetter<String> getter = (ElementsGetter<String>) col.createElementsGetter();
